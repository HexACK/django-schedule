...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('workflow_state', models.PositiveSmallIntegerField(default=10, db_index=True, choices=[(10, 'Tentative'), (20, 'Confirmed'), (30, 'Cancelled')])),
                ...
                ('calendar', models.ForeignKey(to='schedule.Calendar', blank=True, on_delete=models.CASCADE)),
                ('creator', models.ForeignKey(verbose_name='creator', to=settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'event',
                'verbose_name_plural': 'events',
                'permissions': (('can_publish_event', 'Can publish an event'), ('can_see_offline_event', 'Can see an offline event')),
            },
        ),
        migrations.CreateModel(
            name='EventRelation',
